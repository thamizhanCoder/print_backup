...
class EmployeeCustomerChatController extends Controller
{
    //Employee Chat list
    ...
    //Chat conversation
    public function empcuschatConversation(Request $request)
    {
        try {
            ...
            if ($count > 0) {
                ...
                return response()->json([
                    'keyword' => 'success',
                    'message' => __('Chat conversions listed successfully'),
...

    {
        try {
            ...
            if ($chatwithadmin->save()) {
                ...
                $commun->communication_id = $chatwithadmin->communication_id;
                ...
                if ($commun->save()) {
                    ...
                    $communs = Communication::where('communication_id', $chatwithadmin->communication_id)->first();
                    return response()->json([
                        'keyword'      => 'success',
    ...
    public function conversationhistory_view(Request $request)
    {
        try {
            ...
            if (!empty($final)) {
                ...
                return response()->json([
                    'keyword' => 'success',
                    'message' => __('Employee conversations listed successfully'),
                    'data' => $final
                ]);
            } else {
                return response()->json([
    ...
    public function getCommunicationHistory($communicationId)
    {
        ...
        $converslisthistory = CommunicationInbox::where('communication_id', $communicationId)
            ->select('communication_inbox_id', 'communication_id', 'messages', 'attachments', 'employee_id', 'acl_user_id', 'folder', 'reply_on')->get();
    ...
    public function admincommunication_list(Request $request)
    {
        try {
            ...
            if (!empty($final)) {
                ...
                return response()->json([
                    'keyword' => 'success',
                    'message' => __('Administrator chats listed successfully'),
                    'data' => $final,
                    'count' => $count,
                    'completed' => $completed,
