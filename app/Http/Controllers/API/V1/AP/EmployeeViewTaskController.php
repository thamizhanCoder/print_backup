...
class EmployeeViewTaskController extends Controller
{
    ...
    public function todoList(Request $request)
    {
        ...
        if (!empty($final)) {
            return response()->json([
                'keyword' => 'success',
                'message' => __('To do listed successfully'),
                'data' => $final,
                'count' => $count
            ]);
        } else {
    ...
    public function inprogressList(Request $request)
    {
        ...
        if (!empty($final)) {
            return response()->json([
                'keyword' => 'success',
                'message' => __('In progress listed successfully'),
                'data' => $final,
                'count' => $count
            ]);
        } else {
    ...
    public function photoFrameimageVerificationList(Request $request, $ordId)
    {
        try {
            ...
            if (!empty($final)) {
                ...
                return response()->json([
                    'keyword' => 'success',
                    'message' => __('Order items listed successfully'),
                    'data' => $final,
                    'count' => $count
                ]);
            } else {
    ...
    public function moveToQc(Request $request)
    {
        try {
            ...
            if ($upload->save()) {
                ...
                return response()->json([
                    'keyword'      => 'success',
                    'message'      => __('Move to qc successfully'),
                    'data'        => []
    ...
    public function moveToTaskQc(Request $request)
    {
        try {
            ...
            if ($upload->save()) {
                ...
                return response()->json([
                    'keyword'      => 'success',
                    'message'      => __('Move to task qc successfully'),
                    'data'        => $taskHistory
    ...
    public function countSummaryTaskManager(Request $request)
    {
        //Total Products
        $emp_id = ($request->id) ? $request->id : "";
