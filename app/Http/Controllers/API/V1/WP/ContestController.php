...
class ContestController extends Controller
{
    ...
    public function mycontest_list(Request $request)
    {
        try {
            $id = JwtHelper::getSesUserId();
            ...
            foreach ($get_contest as $contest) {
                ...
                $contestArray['ending_on'] = $contest['validity_to'];
    ...
    public function mycontest_view($id)
    {
        try {
    ...
    public function upcoming_contest_list(Request $request)
    {
        try {
