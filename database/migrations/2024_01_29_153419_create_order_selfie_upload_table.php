...
class CreateOrderSelfieUploadTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_selfie_upload', function (Blueprint $table) {
            $table->bigIncrements('order_selfie_upload_id');
            ...
            $table->integer('qc_status')->default('0')->comment('0-pending : 1- approved : 2-rejected')->nullable();
            ...
            $table->integer('preview_status')->default('0')->comment('0-pending : 1- approved : 2-rejected')->nullable();
    ...
    {
        Schema::dropIfExists('order_selfie_upload');
    }
}
