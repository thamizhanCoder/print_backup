            ...
            <td align="center">
               <section >
                ...
                <a style="cursor: none; pointer-events: none;" href="#">
                  ...
                  <section style="padding: 20px;margin: auto; margin-top: 55px; margin-bottom: 15px;">
                     <div>
                        ...
                        <div style="background-color: #18448f; padding: 10px 25px ;">
                           <table style="width: 100%; border-collapse: collapse;">
                              <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.75);">
                                 <td style="padding: 10px 10px 10px 0px;"><span style="font-size: 20px; color: #ffff; font-weight: 700; font-family: 'Rubik', sans-serif;">Order ID:</span> </td>
                           ...
                           <table style="width: 100%; border-collapse: collapse;">
                              <tr>
                                 <td style="padding: 10px 10px 10px 0px;"><span style="font-size: 20px; color: #ffff; font-weight: 700; font-family: 'Rubik', sans-serif; padding-bottom: 20px;">Ordered Items</span> </td>
                           ...
                           <?php foreach ($user['order_items']  as $resource) { ?>
                              ...
                              <tr style="vertical-align: baseline;">
                                 <td style="padding: 10px 10px 10px 0px;"><span style="font-size: 18px; color: #ffff; font-weight: 400; font-family: 'Rubik', sans-serif;">
                                 <?php echo $resource['product_name'] ?></span> </td>
                                 <td style="text-align: end;white-space: nowrap; padding: 10px 0px; font-size: 18px; color: #ffff; font-weight: 400; font-family: 'Rubik', sans-serif;">
