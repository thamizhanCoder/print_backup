            ...
            <td>
               <section>
                  ...
                  <section class="inner_cont" style="padding: 20px;">
                     ...
                     <div>
                        <h1 style="font-size: 24px; font-weight: 700;color: #18448F; font-family: 'Rubik', sans-serif; text-align: center; margin-bottom: 6px; margin-top: 40px;"><span style="color: #000;">Rejected Image Acknowledgement </span></h1>
                     </div>
                     <div style="margin-top: 20px; margin-bottom: 15px;">
                        <div>
                           <p style="font-size: 20px; color: #000; font-weight: 600; font-family: 'Rubik', sans-serif;">Dear <span style="color: #18448F;">{{$customer_name}},</span></p>
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 400;color: #000; line-height: 20px;text-align:justify;">
                              We hope this message finds you well. The purpose of the mail is to accept your previous email and we are working on the image rejection, will send you the updated image as soon as.
                           </p>
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 400;color: #000; line-height: 20px;text-align:justify;">
