               ...
               <section >
                           ...
                           <td>
                              <div style="height: 84px; width: 84px; margin-top: 15px">
                                 <img style="height: 100%; width: 100%"
                                    src="{{ env('WEBSITEURL') }}public/register_assets/logo.png" alt="" />
                              </div>
                           </td>
                        </tr>
                     </table>
                  ...
                  <section class="inner_cont" style="padding: 20px;">
                     ...
                     <div style="margin-bottom: 15px;margin-top: 40px;">
                        <div>
                            <h1 style="font-size: 24px; font-weight: 700;color: #18448F; font-family: 'Rubik', sans-serif; text-align: center; margin-bottom: 6px; margin-top: 0px;"><span style="color: #000;">Request for New Image </span></h1>
                       
                           <p style="font-size: 18px; color: #000; font-weight: 600; font-family: 'Rubik', sans-serif;">Dear <span style="color: #18448F;">{{$customer_name}} ,</span></p>
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 400;color: #000; line-height: 20px;text-align: justify;">
                              We hope this message finds you well. We are writing to inform you that we are unable to process your recent order <b>{{ $order_id }}</b> due to an issue with the image you provided. Upon review, we found the following problem(s) with the image.
                           </p>
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 500;color: #000; line-height: 20px;">Rejected Reason: </p>
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 600;color: #000; line-height: 20px;text-align:justify">{{ $reason }} </p>
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 400;color: #000; line-height: 20px;text-align:justify">
                           ...
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 400;color: #000; line-height: 20px;">Find the attachment below.</p>
                           </p>
                        </div>
                     </div>
                  </section>
