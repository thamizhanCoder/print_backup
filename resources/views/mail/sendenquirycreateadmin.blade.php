            ...
            <td>
               <section>
                ...
                <a style="cursor: none; pointer-events: none;" href="#">
                            ...
                            <h3 style="font-size: 18px;font-weight: 600;color: green;font-family: 'Rubik', sans-serif;">Enquiry Created Successfully</h3>
                         </div>
                        <div>
                          
                           <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 400;color: #000; line-height: 25px;text-align: justify;">
                           This email is to inform you that an enquiry <b>({{$enquiry_code}})</b> has been successfully created by our team. We are currently working on processing the enquiry and will keep you updated on its progress.</p>
                             <p style="font-size: 14px;font-family: 'Rubik', sans-serif; font-weight: 400;color: #000;line-height: 24px;text-align: justify;">If you have any questions or need further information, please feel free to reach out to us <a href="mailto:printapp2021@gmail.com">printapp2021@gmail.com</a> / <a href="tel:9003923500">+91-9003923500</a>.
                           </p>
