  ...
  <section class="container_width" style="background: #ffff;">
    ...
    <section class="inner_cont" style="width: 80%; margin: auto">
      ...
      <div>
        ...
        <h1 style="font-size: 35px; font-weight: 700;color: #18448F; font-family: 'Rubik', sans-serif; text-align: center; margin-bottom: 6px; margin-top: 40px;"><span style="color: #000;">Quote Reraised Rejected</span></h1>
      ...
      <div style="margin-top: 20px; margin-bottom: 15px;">
        ...
        <div>
          <p style="font-size: 20px; color: #000; font-weight: 600; font-family: 'Rubik', sans-serif;">Dear <?php echo $user['employee_name'] ?> <span style="color: #18448F;">,</span></p>
          ...
          We’re pleased to inform you that your reraised quote <?php echo $user['quote_code'] ?> has been rejected by the admin. 
          </p>
          <p>Rejection Reason: <?php echo $user['notes'] ?></p>
          <!-- <div> -->
